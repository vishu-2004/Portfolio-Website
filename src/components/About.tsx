  ...
  return (
    <div className='bg-white flex font-title pb-20 p-7 flex-row'>
      ...
      <div className='w-[53%] pl-16 pt-8'>
        ...
        <p className='text-[17px] font-normal mt-2'>Hi! I’m Vishal Shitole, a passionate React Native and React developer with a knack for building dynamic, user-friendly mobile applications. Beyond coding, I’m a cloud computing enthusiast,exploring ways to integrate cloud technologies in mobile applications for scalable solutions. </p>
        <p className='text-[17px] font-normal mt-2'>
